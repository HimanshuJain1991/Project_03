...
<body class="hm">
					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Account Number</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font></br>
							<%
								...
								%> --%>
								<span class="pl-sm-5"><b>Payment Date</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" id="defaultForm-email"
											name="paymentDate" placeholder=" Enter Payment Date"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="defaultForm-email"
											maxlength="10" name="paymentMode"
											placeholder="Enter Payment Mode"
											value="<%=DataUtility.getStringData(dto.getPaymentMode())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("paymentMode", request)%></font></br>
								<span class="pl-sm-5"><b>Payment Type</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" maxlength="10"
											name="paymentType" placeholder="Enter Payment Type"
											value="<%=DataUtility.getStringData(dto.getPaymentType())%>">
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("paymentType", request)%></font></br>
								</div>
