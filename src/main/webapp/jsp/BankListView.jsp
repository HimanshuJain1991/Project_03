			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="bankAccountNumber"
						...
						value="<%=ServletUtility.getParameter("bankAccountNumber", request)%>">
				</div>
				&emsp;
				<%-- <div class="col-sm-2"><%=HTMLUtility.getList("bankAddress", String.valueOf(dto.), list1)%></div> --%>
				&emsp;

				<div class="col-sm-2">
					<input type="text" name="bankDOB" class="form-control"
			...
			<div class="row">
				<div class="col-sm-2">
					<input type="text" name="bankIFSC" placeholder="Bank IFSC"
						class="form-control "
						value="<%=ServletUtility.getParameter("bankIFSC", request)%>">
				</div>
				<%-- <div class="col-sm-2">
					<input type="text" name="BankMode" placeholder="Search Bank Mode"
						class="form-control "
						value="<%=ServletUtility.getParameter("BankMode", request)%>">
				</div> --%>&emsp;&emsp;
				<div class="col-sm-2">
					<input type="text" name="bankAddress" placeholder="Bank Address"
						class="form-control "
						value="<%=ServletUtility.getParameter("bankAddress", request)%>">
				</div>
			</div>
				...
				<table class="table table-bordered table-primary table-hover">
					<thead>
						<tr style="background-color: aqua;">
							...
							<th width="15%" class="text">Bank Name</th>
							<th width="10%" class="text">Bank Account Number</th>
							<th width="10%" class="text">Bank IFSC</th>
							<th width="10%" class="text">Bank Address</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getBankAccountNumber()%></td>
							<td class="text"><%=dto.getBankIFSC()%></td>
							<td class="text"><%=dto.getBankAddress()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getBankDOB())%></td>
