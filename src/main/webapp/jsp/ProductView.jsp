					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Product Number</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="produceNumber"
											placeholder=" Product  Number"
											value="<%=DataUtility.getStringData(dto.getProduceNumber())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("produceNumber", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="defaultForm-email"
											name="productDOB" placeholder=" Enter Product DATE"
											value="<%=DataUtility.getDateString(dto.getProductDOB())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("productDOB", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" 
											...
											value="<%=DataUtility.getStringData(dto.getProductType())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("productType", request)%></font></br>
								
								<span class="pl-sm-5"><b>Product Address</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" 
											name="productAddress" placeholder="Enter Product Address"
											value="<%=DataUtility.getStringData(dto.getProductAddress())%>">
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("productAddress", request)%></font></br>
								</div>
